...
<head>
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>tools/plugins/summernote/summernote-bs4.css">
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url(); ?>index.php/Admin/eprofile" class="nav-link">Settings</a>
      </li>
    <?php } ?>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo base_url(); ?>uploads/propic/<?php echo $this->session->userdata('pic'); ?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block"><?php echo $this->session->userdata('uid'); ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        ...
        <?php } ?>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <?php if($this->session->userdata('logas')=='student'){ ?>
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/interncontroller/myintern" class="nav-link">
            ...
            <?php } ?>
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/interncontroller/viewintern" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Internship </p>
                </a>
              </li>
              <?php if($this->session->userdata('logas')=='employer'){ ?>
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>createinternship" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <?php if($this->session->userdata('logas')=='admin' or $this->session->userdata('logas')=='employer'){ ?>
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/interncontroller/snotice"  class="nav-link">
            ...
            <?php if($this->session->userdata('logas')=='admin' ) { ?>
            <li class="nav-item">
                <a href="<?php echo base_url(); ?>index.php/interncontroller/createnotice"  class="nav-link">
                  <i class="fas fa-th nav-icon"></i>
                  <p>Create  Notice</p>
                </a>
              </li>
          ...
          <?php if($this->session->userdata('logas')=='employer'){ ?>
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>index.php/interncontroller/applicant" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                View Applicant
                <span class="right badge badge-danger">New</span>
        ...
        <?php if($this->session->userdata('logas')=='admin'){ ?>
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>index.php/interncontroller/verifyapplicant" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                verify Applicant
                <span class="right badge badge-danger">New</span>
